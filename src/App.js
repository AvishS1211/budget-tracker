  ...
  if (loading) {
    return (
      <div style={{ minHeight: "100vh", background: "#0D0D1A", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div style={{ color: "#7B68EE", fontSize: 14, letterSpacing: 2 }}>LOADING YOUR DATA...</div>
      </div>
    );
  }
    ...
    <div style={{ minHeight: "100vh", background: "#0D0D1A", fontFamily: "'DM Sans', sans-serif", color: "#E8E8F0", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          {editBudget ? (
            <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
              ...
              <button onClick={() => saveBudget(Number(budgetInput))} style={{ background: "#82E0AA22", border: "1px solid #82E0AA44", color: "#82E0AA", borderRadius: 8, padding: "6px 12px", fontSize: 12 }}>Save</button>
      ...
      <div style={{ maxWidth: 480, margin: "16px auto 0", padding: "0 24px", display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
        {[
          ...
          <div key={i} style={{ background: "#13131f", borderRadius: 16, padding: "14px 12px", border: "1px solid #ffffff08", textAlign: "center" }}>
            ...
            {recent.length === 0 ? (
              ...
              <div style={{ background: "#13131f", borderRadius: 20, padding: 20, border: "1px solid #ffffff08" }}>
                ...
                {recent.map((exp, i) => {
                  ...
                  return (
                    <div key={exp.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 0", borderBottom: i < recent.length - 1 ? "1px solid #ffffff08" : "none" }}>
